...
public class PostController {
  ...
  @PostMapping("/posts")
  public String createPost(@Parameter(description = "게시글 작성 내용")
  ...
  @GetMapping("/posts/{id}")
  public String getPostById(@Parameter(description = "특정 게시글 ID")
  ...
  @PutMapping("/posts/{id}")
  public String updatePost(@Parameter(description = "게시글 수정 내용")
  ...
  public String deletePost(@Parameter(description = "특정 게시글 ID")
                           @PathVariable Long id) {
    return id + "번 게시물 삭제";
  }
}

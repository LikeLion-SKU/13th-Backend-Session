...
public class PostController {
  ...
  public ResponseEntity<List<PostResponse>> getNewestPosts() {
    return ResponseEntity.ok(postService.getPostsByNewest());
  }
  ...
  public ResponseEntity<List<PostResponse>> getPopularPosts() {
    return ResponseEntity.ok(postService.getPostsByViews());
  }
}

...
public class PostController {
  ...
  @PostMapping("/posts")
  public ResponseEntity<PostResponse> createPost(@Parameter(description = "게시글 작성 내용") @RequestBody CreatePostRequest createPostRequest) {
  ...
  public ResponseEntity<List<PostResponse>> getAllPostsLatest() {
    return ResponseEntity.ok(postService.getAllPostsLatest());
  }
  ...
  public ResponseEntity<List<PostResponse>> getAllPostsPopular() {
    return ResponseEntity.ok(postService.getAllPostsPopular());
  }

...
public class PostController {
    ...
    @Operation(summary = "게시글 생성", description = "게시글 페이지에서 게시글 작성 후 생성 버튼을 눌렀을 때 요청되는 API")
    @PostMapping("/posts")
    ...
    @GetMapping("/posts/{id}")
    public String getPostById(@Parameter(description = "특정 게시글 ID") @PathVariable Long id) {
        return id + "번 게시글 조회";
    }

    @Operation(summary = "게시글 수정", description = "게시판 페이지에서 게시글 수정 후 수정 완료 버튼을 눌렀을 때 요청되는 API")
    @PutMapping("/posts/{id}")
    public String updatePost(@Parameter(description = "특정 게시글 ID") @PathVariable Long id,
    ...
    public String deletePost(@Parameter(description = "특정 게시글 ID") @PathVariable Long id) {
        return id + "게시글 삭제";
    }
}
